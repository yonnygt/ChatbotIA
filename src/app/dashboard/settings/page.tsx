        ...
        <div className="min-h-dvh bg-[#f3f6f4] pb-24">
            ...
            <div className="px-5 pt-14 pb-6">
                <div className="flex items-center gap-3 mb-1">
                    <Link href="/dashboard" className="h-9 w-9 rounded-xl bg-white border border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-colors shadow-sm">
            ...
            <div className="px-5 space-y-4">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="h-10 w-10 rounded-xl bg-emerald-50 flex items-center justify-center">
                            <span className="material-symbols-outlined text-emerald-600 text-[20px]">currency_exchange</span>
                        </div>
                        <div>
                            <h3 className="text-sm font-bold text-gray-900">Tasa de Cambio BCV</h3>
                            <p className="text-xs text-gray-400">Dólar oficial del Banco Central</p>
                        </div>
                    </div>

                    <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="bg-[#f3f6f4] rounded-xl p-3 text-center">
                            ...
                            <p className="text-[10px] text-gray-400">Bs/USD</p>
                        </div>
                        <div className="bg-[#f3f6f4] rounded-xl p-3 text-center">
                    ...
                    <button
                        onClick={handleSync}
                        disabled={syncing}
                        className="w-full py-3 rounded-xl bg-primary text-white font-bold text-sm shadow-soft hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                    ...
                    {syncResult && (
                        <p className="text-xs text-center mt-3 text-gray-600">{syncResult}</p>
                    )}
                </div>
                ...
                {user?.role === "admin" && (
                    <Link
                        ...
                        className="flex items-center gap-4 bg-white border border-gray-200 rounded-2xl p-4 hover:border-primary/30 transition-colors shadow-sm"
                    >
                        <div className="h-10 w-10 rounded-xl bg-blue-50 flex items-center justify-center">
                            <span className="material-symbols-outlined text-blue-500 text-[20px]">group</span>
                        </div>
                        <div className="flex-1">
                            <p className="text-sm font-bold text-gray-900">Gestionar Usuarios</p>
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 rounded-2xl bg-red-50 border border-red-200 text-red-500 font-bold text-sm hover:bg-red-100 transition-all"
                >
